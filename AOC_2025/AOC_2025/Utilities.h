...
public:
    ...
    static std::string& Ltrim(std::string& str, const char* c = wstr);
    static std::string& Rtrim(std::string& str, const char* c = wstr);
    static std::string& trim(std::string& str, const char* c = wstr);
